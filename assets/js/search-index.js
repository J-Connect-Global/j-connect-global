window.JCONNECT_SEARCH_INDEX = [
  {
    ...
    description: "ドイツ在住日本人向けの生活ポータル。仕事、医療、グルメ、買い物、掲示板、イベント、手続き、ドイツ語学習まで整理しています。",
    url: "/germany/ja/",
    category: "ホーム",
    tags: ["ドイツ生活", "日本人", "ポータル", "デュッセルドルフ", "生活情報", "仕事", "医療", "グルメ", "買い物", "掲示板"]
  },
  {
    title: "このサイトについて",
    ...
    category: "サイト案内",
    tags: ["J-Connect Germany", "理念", "掲載方針", "運営", "生活ポータル"]
  },
  {
    title: "お問い合わせ",
  ...
  },
  {
    ...
    url: "/germany/ja/news/",
    category: "情報",
    tags: ["ニュース", "制度変更", "行政", "交通", "安全", "ドイツ生活", "読みもの"]
  },
  {
    title: "おでかけ・イベント",
    ...
    category: "イベント",
    tags: ["イベント", "おでかけ", "週末", "季節", "家族", "交流", "デュッセルドルフ", "ドイツ生活"]
  },
  {
    title: "手続き・制度",
    description: "住民登録、滞在許可、健康保険、税金、銀行、雇用、家族、交通などの基本手続きを整理しています。",
    url: "/germany/ja/guides/",
    category: "暮らし",
    tags: ["手続き", "制度", "住民登録", "Anmeldung", "滞在許可", "ビザ", "保険", "健康保険", "税金", "銀行", "ドイツ生活"]
  },
  {
    title: "ドイツ語・学び",
    ...
    category: "学び",
    tags: ["ドイツ語", "学習", "勉強", "日常会話", "仕事", "試験", "アプリ", "AI", "ドイツ生活"]
  },
  {
    title: "暮らし・生活",
    description: "住まい、行政手続き、医療、銀行、通信、交通、買い物、家族・教育の基本情報を整理しています。",
    url: "/germany/ja/living/",
    category: "暮らし",
    tags: ["生活", "暮らし", "ドイツ生活", "デュッセルドルフ", "住まい", "通信", "交通", "銀行", "家族", "教育", "保険"]
  },
  {
    title: "仕事・求人",
    ...
    url: "/germany/ja/jobs/",
    category: "仕事",
    tags: ["仕事", "求人", "転職", "アルバイト", "就職", "採用", "ビザ", "ビザサポート", "日本語求人", "ドイツ生活"]
  },
  {
    title: "求人掲載希望の企業様へ",
  ...
  },
  {
    ...
    category: "医療",
    tags: ["医療", "病院", "クリニック", "家庭医", "薬局", "緊急", "救急", "保険", "健康保険", "デュッセルドルフ"]
  },
  {
    title: "グルメ・飲食",
    ...
    url: "/germany/ja/eat/",
    category: "食",
    tags: ["グルメ", "飲食", "日本食", "和食", "レストラン", "ラーメン", "カフェ", "寿司", "居酒屋", "デュッセルドルフ"]
  },
  {
    title: "買い物・サービス",
    ...
    category: "買い物",
    tags: ["買い物", "ショッピング", "スーパー", "食材店", "日本食", "アジアスーパー", "薬局", "日用品", "サービス", "デュッセルドルフ"]
  },
  {
    title: "交流・掲示板",
    ...
    category: "コミュニティ",
    tags: ["掲示板", "交流", "コミュニティ", "売ります", "買います", "譲ります", "友達募集", "質問", "部屋", "デュッセルドルフ"]
  },
  {
    title: "掲示板に投稿する",
    ...
    category: "コミュニティ",
    tags: ["投稿", "掲示板", "売買", "売ります", "買います", "募集", "質問", "イベント"]
  },
  {
    title: "投稿者に連絡",
