...
![妊娠判明から婦人科、助産師、出産準備、出生届、保険と給付までの流れ](/assets/images/living/pregnancy-birth-timeline.svg "医療・助産師・職場・行政を並行して進める")

> **2026年7月19日再確認：** gesund.bund.deは妊娠中・産後の定期検査と相談、3回の基本超音波検査を案内しています。Hebammeの支援は健康保険の対象ですが、PKVは契約範囲を個別に確認してください。強い痛みや出血などは記事で判断せず医療機関へ連絡してください。
...
1. **妊娠判明後、婦人科で妊娠確認とMutterpassの発行を受ける**
2. **妊娠初期からHebamme、つまり助産師を探す**
3. **Klinik、Geburtshaus、自宅出産など出産場所を早めに検討する**
4. **健康保険に、検診、出産、助産師、産後ケアの扱いを確認する**
5. **雇用されている場合は、職場報告、Mutterschutz、Mutterschaftsgeldを確認する**
6. **出産後はStandesamt、健康保険、Elterngeld、Kindergeldを順番に処理する**
...
### 婦人科に妊娠確認の予約を依頼する
    ...
    Der erste Tag meiner letzten Periode war am [Datum].
    Ich bin bei [Name der Krankenkasse] versichert.
...
### Hebammeに問い合わせる
    ...
    Ich wohne in [Ort/Stadtteil].
    Meine Krankenkasse ist [Name der Krankenkasse].

    Haben Sie für diesen Zeitraum noch Kapazitäten?
...
### 出産施設に登録方法を問い合わせる
    ...
    Ich möchte mich gerne informieren, wie die Anmeldung zur Geburt in Ihrer Klinik funktioniert.
    Gibt es eine Kreißsaalführung oder einen Informationsabend für werdende Eltern?
...
### 勤務先に妊娠を報告する
    ...
    hiermit möchte ich Sie darüber informieren, dass ich schwanger bin.
    Der voraussichtliche Entbindungstermin ist der [Datum].
...
- [ ] 産後訪問の対応可否を確認した
- [ ] 出産施設の候補を比較した
- [ ] KreißsaalführungまたはInfoabendを確認した
- [ ] Anmeldung zur Geburtの時期を確認した
- [ ] 緊急搬送先やNICUの有無を確認した
- [ ] 家族部屋や個室の費用を確認した
...
- [ ] 健康保険の妊娠・出産カバーを確認した
- [ ] Hebamme費用の扱いを確認した
- [ ] Geburtsvorbereitungskursの補助を確認した
- [ ] Rückbildungskursの補助を確認した
- [ ] Mutterschaftsgeldの申請方法を確認した
- [ ] Arbeitgeberzuschussの扱いを確認した
- [ ] Elterngeldの概算を確認した
...
- [ ] 妊娠報告の時期を検討した
- [ ] 業務上のリスクを確認した
- [ ] Mutterschutzfristを確認した
- [ ] Elternzeitの取得期間を検討した
- [ ] パートナーの育休月を検討した
- [ ] 復職予定とKita開始時期を確認した

### 出産後手続き

- [ ] Standesamtの必要書類を確認した
- [ ] 子どもの名前表記を決めた
- [ ] Geburtsurkundeの必要部数を確認した
- [ ] 子どもの健康保険加入方法を確認した
- [ ] 小児科を探した
- [ ] Elterngeld申請書類を準備した
- [ ] Kindergeld申請方法を確認した
...
4. Hebammeを探し始める
5. 出産施設の候補を調べる
6. 健康保険に妊娠・出産関連のカバー範囲を確認する
7. 職場への報告時期を検討する
8. MutterschutzとMutterschaftsgeldの基本日程を確認する
9. Standesamtに出生届の必要書類を確認する
10. Elterngeld、Kindergeld、Elternzeitの準備を始める
11. 日本側出生届・国籍関連を確認する
12. 子どもの健康保険と小児科を確認する
...
- [Familienportal des Bundes: Schwangerschaft & Geburt](https://familienportal.de/familienportal/lebenslagen/schwangerschaft-geburt)
- [Familienportal des Bundes: Staatliche Leistungen in der Schwangerschaft und nach der Geburt](https://familienportal.de/familienportal/lebenslagen/schwangerschaft-geburt/staatliche-leistungen)
- [Familienportal des Bundes: Mutterschutz](https://familienportal.de/familienportal/familienleistungen/mutterschutz)
- [Familienportal des Bundes: Mutterschaftsleistungen](https://familienportal.de/familienportal/familienleistungen/mutterschaftsleistungen)
- [Familienportal des Bundes: Anmeldung Ihres Kindes beim Standesamt](https://familienportal.de/familienportal/lebenslagen/schwangerschaft-geburt/anmeldung-standesamt)
- [Familienportal des Bundes: Elternzeit](https://familienportal.de/familienportal/familienleistungen/elternzeit)
- [Familienportal des Bundes: Elterngeld](https://familienportal.de/familienportal/familienleistungen/elterngeld)
- [Familienportal des Bundes: Kindergeld](https://familienportal.de/familienportal/familienleistungen/kindergeld)
