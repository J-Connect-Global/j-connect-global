(function (window) {
  ...
  function normalizePost(post, index) {
    ...
    return {
      ...
      category1: pick(post, ["category1", "post_type", "postType", "type", "category"]),
      category2: pick(post, ["category2", "subcategory", "sub_category", "detail_category"]),
      country: pick(post, ["country", "country_name", "countryName"]),
      region,
      city,
      nickname: pick(post, ["nickname", "display_name"]),
      price: pick(post, ["price", "fee", "salary", "budget"]),
      availability_date: pick(post, ["availability_date", "event_date"]),
      tags: pick(post, ["tags"]),
      status,
      created_at: pick(post, ["created_at", "createdAt", "date", "timestamp"]),
      updated_at: pick(post, ["updated_at", "updatedAt"]),
      published_at: pick(post, ["published_at", "publishedAt"]),
      expires_at: pick(post, ["expires_at", "expiresAt"]),
      closed_at: pick(post, ["closed_at", "closedAt"]),
      _id: id,
