...
slug: "vhs-german-course-guide"
category: "教材・リソース"
summary: "VHSのドイツ語コースを探す方法、レベル選び、料金・補助制度で確認すべき点、J-Connect記事との組み合わせ方を整理します。"
status: "published"
published: true
...
| コース名 | 内容の目安 |
| --- | --- |
| Deutsch A1.1 | A1前半。初めて学ぶ人向け |
| Deutsch A1.2 | A1後半。基本文法と日常表現の継続 |
| Deutsch A2 | 日常会話を少し広げる段階 |
| Deutsch B1 | 理由説明、経験、意見、生活上の複雑な場面 |
| Deutsch B2 | 仕事、大学、社会的テーマなどで使う段階 |
| Intensivkurs | 週に複数回ある集中コース |
| Abendkurs | 夜のコース。仕事後に通いやすい |
| Onlinekurs | オンライン受講 |
| Prüfungsvorbereitung | 試験対策 |
| Integrationskurs | 統合コース関連 |
| Berufssprachkurs | 職業ドイツ語関連 |
...
>
> ich interessiere mich für den Deutschkurs A1.1. Ist dieser Kurs für absolute Anfänger geeignet? Gibt es noch freie Plätze? Muss ich vor der Anmeldung einen Einstufungstest machen?
>
...
| 場面 | 使う文 |
| --- | --- |
| 予約 | Ich möchte einen Termin vereinbaren. |
| 役所 | Ich möchte meinen Wohnsitz anmelden. |
| 病院 | Ich möchte einen Termin beim Arzt. |
| 住まい | Ich möchte einen Schaden melden. |
| 買い物 | Ich möchte mit Karte zahlen. |
...
1. [A1から生活で困らないレベルを目指すドイツ語ルート](/germany/ja/learn-german/a1-daily-life-german-route/)
2. [買い物で使うドイツ語](/germany/ja/learn-german/shopping-phrases/)
3. [電話でよく使うドイツ語](/germany/ja/learn-german/telephone-phrases/)
4. [予約を取りたいときのドイツ語フレーズ](/germany/ja/learn-german/appointment-phrase/)
5. [病院予約の電話で使うドイツ語](/germany/ja/learn-german/hospital-phrases/)
6. [役所・Anmeldungで使うドイツ語フレーズ](/germany/ja/learn-german/behoerde-anmeldung-phrases/)
...
* [A1から生活で困らないレベルを目指すドイツ語ルート](/germany/ja/learn-german/a1-daily-life-german-route/)
* [B1を目指す生活ドイツ語ルート](/germany/ja/learn-german/b1-daily-life-german-route/)
* [B2で仕事に使うドイツ語ルート](/germany/ja/learn-german/b2-work-german-route/)
